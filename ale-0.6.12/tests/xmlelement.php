...
require_once '../ale/parser/xmlelement.php';

class AleParserXMLElementTest extends PHPUnit_Framework_TestCase
{
	public function testCalendarEventAttendees()
	{
		$data = file_get_contents('data/CalendarEventAttendees.xml.aspx');
		
		$parser = new AleParserXMLElement($data);
	...
	{
		$data = file_get_contents('data/KillLog.xml.aspx');
	...
	{
		$data = file_get_contents('data/AssetList.xml.aspx');
